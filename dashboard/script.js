...
// function drawChart() {
//     arregloDatos = [['Gráfico', ''],['ingresos',50000],['gastos',35000]];
...
var arregloDatos = [['Ingresos', 'efectivo','transferencia'],
                    ['Lunes',50000,25000],
                    ['martes',35000,15000],
                    ['miércoles',35000,0],
                    ['jueves',40000,10000],
...
function drawVisualization() {
    ...
    //     chart.draw(data, options);
    // } else {
        let chart = new google.visualization.ComboChart(document.getElementById('piechart'));
        chart.draw(data, options);
